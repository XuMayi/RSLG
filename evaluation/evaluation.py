...
def f1_score(prediction, ground_truth):
    ...
    prediction_tokens = [word for word in prediction_tokens if word not in stop_words]
    ground_truth_tokens = [word for word in ground_truth_tokens if word not in stop_words]
