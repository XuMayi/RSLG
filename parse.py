...
def parse_args():
    ...
    parser.add_argument("--test_dataset", nargs="?", default="longhopqa",choices=['hotpotqa', '2wikimqa', 'musique', 'fanoutqa', 'longhopqa', 'hotpotqa_val', '2wikimqa_val', 'musique_val'])

    parser.add_argument("--max_dep", type=int, default=4)
    ...
    parser.add_argument("--test_step", type=int, default=4)

    parser.add_argument("--llm", type=str, default='llama',choices=["llama","mistral",'qwen'])
    parser.add_argument("--version", type=str, default='v38')
